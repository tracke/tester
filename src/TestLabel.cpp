...
void CreateLabelImage(int Width, int Height)
{
...
int main(int argc, char** argv)
{
  try
  {
    ...
    printf("Please Insert '30256 Shipping' paper. Press 'c' to continue, 'a' to abort: "); //w167h288
    int ch = 0;
    ch = getchar();
    ...
    int Width = 1112;  // 4.08 4.32 163.68 271.20 (159.6) (266.88)
    int Height = 664;
    ...
    num_options = cupsAddOption("PageSize", "w72h72", num_options, &options);
